...
public class Graph{
  ...
  public List<Vertex> getVertices(){
    ...
    //TODO 1: Liste kopieren und zurückgeben.
  ...
  public List<Edge> getEdges(){
    ...
    //TODO 2: Liste kopieren und zurückgeben
  ...
  public Vertex getVertex(String pID){
    ...
    //TODO 3: Knoten suchen und zurückgeben.
    Vertex result = null;
    List<Vertex> help = this.getVertices();
    help.toFirst();
    while(help.hasAccess()) {
      if (pID.compareTo(help.getContent().getID()) == 0) {
        result = help.getContent();
      }
      help.next();
    }
  ...
  public void addVertex(Vertex pVertex){
    ...
    if (pVertex != null && pVertex.getID() != null) {
      ...
      if(this.getVertex(pVertex.getID()) != null){
        freeID = false;
      }
      if(freeID == true){
        this.getVertices().append(pVertex);
      }
    }
  }
